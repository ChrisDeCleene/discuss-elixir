...
config :discuss, DiscussWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "33brmpxLZ4Umn49IUcetjc/S0U/UuvotHi/hxI2aYCtDG7CkwhmHWuR0oICp8I1e",
  render_errors: [view: DiscussWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: Discuss.PubSub,
  live_view: [signing_salt: "vmvfqGQZ"]
...
config :ueberauth, Ueberauth.Strategy.Github.OAuth,
      client_id: "a79594cab7d860f6e9cc",
      client_secret: "acd693865183ca8a4e71bca7a7df60b4453789ef"
